...
**Bilingual EN+ZH documents:** See `references/bilingual-docx-recipe.md` for the parallel-format translation workflow — paragraph-by-paragraph EN→ZH with dark blue `【中文】` prefixes, table row expansion, and multi-document parallel processing via `delegate_task`.
