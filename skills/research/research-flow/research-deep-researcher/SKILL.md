...
| Tool | Purpose |
|------|---------|
| ArXiv Search | Find recent papers |
| Semantic Scholar | Citation graph, paper details |
| GitHub Search | Find implementations |
| Web Search | Find blog posts, preprints |
| DOI → BibTeX | Generate citations |